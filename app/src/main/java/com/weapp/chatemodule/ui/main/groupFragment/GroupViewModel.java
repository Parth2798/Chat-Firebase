...
public class GroupViewModel extends ViewModel {
    ...
    @Inject
    public GroupViewModel(SessionManager sessionManager, PreferencesClass preferencesClass) {
            ...
            for (DataSnapshot ds : snapshot.getChildren()) {
                ...
                if (ds.getValue() != null) {
                    ...
                    if (friend != null && friend.isGroup()) {
                        ...
                        Logger.e("KKKKKKKKK    ","!!!!!!!!! 111111111111 + " + friend.toString());
                    }
                }
            }

            getAllGroups(friends);
        }
                                                        ...
                                                        if (user != null) {
                                                            ...
                                                            for (int j = 0; j < friends.size(); j++) {
                                                                if (user.getUserId() != null) {
                                                                    if (preferencesClass.getUserID().equals(user.getUserId())) {
