package com.weapp.chatemodule.customeClass.roundImage;
    ...
    private Drawable resolveResource() {
        ...
        if (mResource != 0) {
            try {
                ...
                Logger.e(TAG, "Unable to find resource: " + mResource + "       E:  " + e);
                // Don't try again.
                mResource = 0;
            }
        }
    ...
    private Drawable resolveBackgroundResource() {
        ...
        if (mBackgroundResource != 0) {
            try {
                ...
                Logger.e(TAG, "Unable to find resource: " + mBackgroundResource + "      " + e);
                // Don't try again.
